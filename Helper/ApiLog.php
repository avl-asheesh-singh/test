...
use Avalara\GenericLogger\Logger\GenericLogger;

class ApiLog extends AbstractHelper
{
    const CONNECTOR_ID = 'a0n5a00000ZmXLNAA3';

    const CONNECTOR_STRING = 'a0o5a0000064cqHAAQ';

    const CONNECTOR_NAME = "Magento - AvaTax SalesTax for US";
    ...
    public function apiLog(string $message, array $context = [], $scopeId = null, $scopeType = null)
    {
        if (strlen($message) > 0) {
            ...
            $mode = $isProduction ? \Avalara\GenericLogger\Helper\Generic\Config::API_MODE_PRODUCTION : \Avalara\GenericLogger\Helper\Generic\Config::API_MODE_SANDBOX;
            ...
            $logType = isset($context['config']['log_type']) ? $context['config']['log_type'] : \Avalara\GenericLogger\Helper\Generic\Config::API_LOG_TYPE_DEBUG;
            $logLevel = isset($context['config']['log_level']) ? $context['config']['log_level'] : \Avalara\GenericLogger\Helper\Generic\Config::API_LOG_LEVEL_INFO;
    ...
    public function configSaveLog($scopeId, $scopeType)
    {
        ...
        $logType = \Avalara\GenericLogger\Helper\Generic\Config::API_LOG_TYPE_CONFIG;
        $logLevel = \Avalara\GenericLogger\Helper\Generic\Config::API_LOG_LEVEL_INFO;
